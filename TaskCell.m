...
- (id)initWithStyle:(UITableViewCellStyle)style andFrame:(CGRect)frame reuseIdentifier:(NSString *)reuseIdentifier
{
    self = [super initWithStyle:style reuseIdentifier:reuseIdentifier];
    if (self) {
...
- (void)initializeWithFrame:(CGRect)frame {
    checkbox = [[SSCheckBoxView alloc] initWithFrame:frame style:kSSCheckBoxViewStyleBox checked:NO];
    [self addSubview:checkbox];
}
